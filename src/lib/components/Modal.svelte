<script lang="ts">
	...
	import { use as useAction } from 'sveltewind/actions';
	import { Card, Overlay, Portal } from 'sveltewind/components';
...
<Portal>
	...
	{#if isVisible}
		<div
			{...props}
			bind:this={elem}
			class="max-w-screen pointer-events-none fixed left-0 top-0 z-[1] flex h-full max-h-screen min-h-screen w-full min-w-[100vw] items-center justify-center overflow-auto p-4"
